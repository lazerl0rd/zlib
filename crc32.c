...
#if defined(HAS_PCLMUL) && !defined(ASMV)

#define PCLMUL_MIN_LEN 64
#define PCLMUL_ALIGN 16
#define PCLMUL_ALIGN_MASK 15

/* Function taken from the Linux kernel 3.14. It computes the CRC over the
 * given buffer with initial CRC value <crc32>. The buffer is <len> byte in
 * length, and must be 16-byte aligned.
 */
